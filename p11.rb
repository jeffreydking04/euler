...
# Problem 11 from the Euler Project.  We are given the array and we must find any
# four consecutive numbers, whether horizontal, diagonal (both directions), or vertical,
# and find their product.  Largest product wins.